...
同梱IERS EOPは1973-01-02 00:00 UTC〜2027-08-07 00:00 UTCを収録し、
...
得た1955〜2005年は補正しない。2027-08-07 00:00 UTCより後は、補正済み
多項式の変化量を同梱IERS予測最終sampleのΔT 69.239965秒へ連続接続する。

| 年月 | 使用するΔT | 時刻の保守的不確かさ | 地球赤道上の経路換算 |
| --- | ---: | ---: | ---: |
| 1900-01 | −2.745秒 | ±1.0秒 | ±0.47 km |
| 1950-01 | 29.087秒 | ±1.0秒 | ±0.47 km |
| 2050-01 | 86.218秒 | ±16.87秒 | ±7.85 km |
| 2100-01 | 195.901秒 | ±49.32秒 | ±22.94 km |
...
`TAI−UTC=0秒`のproleptic UTC、2027-08-07 00:00 UTCより後は
`TAI−UTC=37秒`を固定した連続UTCシナリオとし、
`DUT1 = TAI−UTC + 32.184 − ΔT`からTT−UT1を再現する。
